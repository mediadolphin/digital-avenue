/* @ds-bundle: {"format":3,"namespace":"DigitalAvenueDesignSystem_019dde","components":[],"sourceHashes":{"pages/frames/browser-window.jsx":"2e3bb69bede4","pages/frames/design-canvas.jsx":"862a6db59c7c","pages/frames/ios-frame.jsx":"d67eb3ffe562","pages/frames/scaled-frame.jsx":"20d04d92aba4"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.DigitalAvenueDesignSystem_019dde = window.DigitalAvenueDesignSystem_019dde || {});

const __ds_scope = {};

(__ds_ns.__errors = __ds_ns.__errors || []);

// pages/frames/browser-window.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "pages/frames/browser-window.jsx", error: String((e && e.message) || e) }); }

// pages/frames/design-canvas.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "pages/frames/design-canvas.jsx", error: String((e && e.message) || e) }); }

// pages/frames/ios-frame.jsx
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "pages/frames/ios-frame.jsx", error: String((e && e.message) || e) }); }

// pages/frames/scaled-frame.jsx
try { (() => {
...
function FrameLabel({
  ...
  }), /*#__PURE__*/React.createElement("strong", null, label), sub && /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#5c6f74',
      fontWeight: 500
    }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "pages/frames/scaled-frame.jsx", error: String((e && e.message) || e) }); }
