...
const PAGES = [
  ...
  { file: 'heilberufe.html', route: 'heilberufe' },
...
const rewriteLinks = (html) => html
  ...
  .replace(/href="(praxen|kanzleien|mittelstand|heilberufe|lp-facharztpraxis|lp-empfang-entlasten|lp-betreuung-wechseln)\.html(#[\w-]+)?"/g, (_, r, a) => `href="#${r}${a ? '/' + a.slice(1) : ''}"`)
