...
| 4 Templates & Seiten | Header und Footer fertig (inkl. mobiles Menü, 13.09.2026), Startseite komplett (Hero, Mosaik, Partner, Für wen, Leistungen, So arbeiten wir, Referenzen, Über uns, Digital-Check, 13.09.2026); offen: Popup Digital-Check mit Formular, drei Landingpages, echte Texte für Kundenstimmen und Referenzen | Aufbau in `handoff/import/README.md`, Schritte 8 bis 11. |
