...
| 3 Komponenten als Global Classes und Components | teilweise (11.09.2026): 23 Klassen am Staging (21 Basisklassen, `service-card` mit Sub-Selektoren, Modifier `sand`), Components „Service-Punkt“ und „Service-Karte“ per MCP angelegt und auf Testseite 50 gerendert; Klassen-Kategorie für `service-card` und die übrigen zehn Components offen | Zuordnung Prototyp-Komponenten zu Bricks-Klassen (Beispiel in `references/component-mapping-example.md`), Stand und Lernpunkte in `handoff/import/README.md`, Schritt 7. |
...
0. Schritte 0 bis 6 aus `handoff/import/README.md` sind am Staging erledigt. Schritt 7 läuft per MCP: Service-Karte fertig, danach Kachel, Schritt, Referenzkarte, Kundenstimme, Pain-Karte, Feature-Block, Concierge, FAQ, Digital-Check-Block, Hero Landingpage. Im Chat gezeigte Anwendungspasswörter widerrufen.
