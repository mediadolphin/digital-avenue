...
| 4 Templates & Seiten | begonnen (11.09.2026): Header (Nav mit Dropdowns Branchen/Referenzen, Umschalter, CTA, Burger) und Footer als Templates per MCP gebaut, Hero der Startseite gesetzt; offen: mobiles Menü, Rest der Startseite, drei Landingpages, Popup Digital-Check | Aufbau in `handoff/import/README.md`, Schritte 8 und 9. |
