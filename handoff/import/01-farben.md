...
| `var(--da-glass)` | `rgb(255 255 255 / 0.92)` | `rgb(29 51 64 / 0.90)` |  |
| `var(--da-glass-border)` | `rgb(255 255 255 / 0.60)` | `rgb(41 70 83 / 0.70)` |  |
| `var(--da-glass-sand)` | `rgb(246 242 234 / 0.94)` | `rgb(42 35 24 / 0.92)` |  |
